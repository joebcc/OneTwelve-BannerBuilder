      ...
      //   .to("#BG", {transformOrigin: 'center', scale: 1.2, x: '-=6', y: '-=10', duration: .35, ease: 'ease-in-out'}, "_f1")
      ...
      //   .to("#BG", {transformOrigin: 'center', scale: 1.4, x: '-=12', y: '-=20', duration: .35, ease: 'ease-in-out'}, "_f2")
      ...
      //   .to("#BG", {transformOrigin: 'center', scale: 1.5, x: '-=15', y: '-=40', duration: 3, ease: 'ease-in-out'}, "_f3")
