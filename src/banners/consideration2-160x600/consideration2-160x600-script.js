      ...
      .to("#BG", {transformOrigin: 'center', scale: 1.1, x: '+=5', y: '-=2', duration: .35, ease: 'ease-in-out'}, "_f1")
      ...
      .to("#BG", {transformOrigin: 'center', scale: 1.2, x: '+=10', y: '-=4', duration: .35, ease: 'ease-in-out'}, "_f2")
      ...
      .to("#BG", {transformOrigin: 'center', scale: 1.4, x: '+=20', y: '-=6', duration: 3, ease: 'ease-in-out'}, "_f3")
