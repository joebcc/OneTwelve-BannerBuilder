      ...
      .to("#BG", {transformOrigin: 'center', scale: 1.1, x: '-=15', y: '-=2', duration: .35, ease: 'ease-in-out'}, "_f1")
      ...
      .to("#BG", {transformOrigin: 'center', scale: 1.2, x: '-=30', y: '-=4', duration: .35, ease: 'ease-in-out'}, "_f2")
      ...
      .to("#BG", {transformOrigin: 'center', scale: 1.4, x: '-=50', y: '-=10', duration: 3, ease: 'ease-in-out'}, "_f3")
      //.add(bg.tweenTo(3).duration(2.5), "<")
      .fromTo("#shine1", {x: '-=0', }, {x: '+=50', opacity: 0, duration: 14, ease: 'ease-in-out'}, "_f1")
      .fromTo("#shine1_300x", {x: '-=0' }, {x: '+=50', opacity: 0, duration: 14, ease: 'ease-in-out'}, "_f1")
      // .fromTo("#shine2", {x: '-=25'}, {x: '+=50',  opacity: .2, duration: 14, ease: 'ease-in-out'}, "_f1")
      .fromTo("#keyshadow",  {transformOrigin: '30% 39%', skewX: '+40'}, {skewX: '-20', duration: 14, ease: 'ease-in-out'}, "_f1")
