      ...
      tl
      .set("#BG", { scale: 1.6, transformOrigin: 'center', x: '+=20', y: '-=70', })
      .fromTo("#wrapper", { opacity: 0}, {opacity: 1, duration: 0.2 }, 0)
  
      // === Frame 1 ===============================
      .from("#f1", loadanim, "_f1+=.25")
      //.add(bg.tweenTo(.35).duration(.35), "<")
      .to("#BG", {transformOrigin: 'center', scale: 1.4, x: '-=4', y: '+=20', duration: .35, ease: 'ease-in-out'}, "_f1")
      ...
      .to("#BG", {transformOrigin: 'center', scale: 1.2, x: '-=4', y: '+=10', duration: .35, ease: 'ease-in-out'}, "_f2")
